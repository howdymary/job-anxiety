    ...
    <div className="grid gap-10">
      ...
      <div className="page-grid-prose prose-block">
        ...
        <section id="what-to-actually-do">
          ...
          <p>
            Advice in moments like this tends to split into two bad forms. Panic talk treats the whole profession as doomed. Smoothing talk pretends nothing fundamental is changing. Neither helps. The more useful approach is to ask what kind of engineer you are now, what part of the job gives you leverage, and which adjacent paths still respect the skills you already have.
          </p>
          <p>
