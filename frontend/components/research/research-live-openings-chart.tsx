...
export function ResearchLiveOpeningsChart({ data, source }: ResearchLiveOpeningsChartProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 h-[22rem] overflow-hidden" role="img" aria-label="Area chart showing the current open-role inventory bucketed by original posting week across tracked company career boards.">
        {hasData ? (
